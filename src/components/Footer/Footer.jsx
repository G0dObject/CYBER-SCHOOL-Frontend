		...
		<div className="footer">
			<Container className="footer">
				<div className="footer__top">
							...
							<div className="footer__col">
								...
								<ul className="footer__link-container">
									{item.links.map((link, index) =>
										<a href={link.path} key={index} className="footer__link">{link.text}</a>
									)}
								</ul>
							</div>
						)}
					...
					<div className="footer-contacts">
						...
						<div className="footer-contacts__mobile">
							<div className="footer-contacts__subtitle">Бесплатный звонок по России</div>
							<a href="tel:88002009929" className="footer-contacts__phone">8 800 200 99 29</a>
						</div>
				...
				<div className="footer__bottom">
					<div className="footer__copyright">Copyright © 1997-2023, ПАО КБ «Центр-инвест», г. Ростов-на-Дону, пр. Соколова, 62 © «Центр-Интернет»</div>
				</div>
			</Container>
		</div>
	);
